        ...
        <a href="http://2-up.ru" title="2up" target="_blank">
          <svg version="1.1" id="Слой_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            ...
            <pattern id="pattern" patternUnits="userSpaceOnUse" width="100%" height="100%">
              <rect width="100%" heigth="100%" fill="url(#grad--linear-1)"></rect>
            </pattern>        
            <path fill="url(#pattern)" d="M143.691,6.421c-3.28-3.402-9.061-5.274-13.729-5.274h-21.891c-0.677,0-1.228,0.549-1.228,1.227v10.557
            ...
            <path fill="url(#pattern)" d="M75.43,55.081c-3.416,0-6.745-0.276-10.015-1.197c-3.345-0.94-6.925-2.85-9.325-5.094c-2.47-2.313-4.225-5.563-5.162-8.701
            ...
            <path fill="url(#pattern)" d="M22.361,42.108c3.85-3.817,6.113-5.021,11.835-9.261c10.155-7.672,10.405-14.03,10.481-14.445
